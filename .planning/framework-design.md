...
```mermaid
graph TD
    P1["Phase 1: Analysis<br/><i>what + which approach</i>"] -->|GATE| P2
    P2["Phase 2: Architecture<br/><i>macro: servers, comms, tech</i>"] -->|GATE| P3
    P3["Phase 3: Design<br/><i>micro: entities, contracts</i>"] -->|GATE| P4
    P4["Phase 4: Decomposition<br/><i>EPIC→STORIES→TASKS→SUBTASKS</i>"] -->|GATE| P5
    P5["Phase 5: Validation<br/><i>requirements check</i>"] -->|approve| P6
    P6["Phase 6: Implementation<br/><i>parallel agents</i>"] -->|GATE| P7
    P7["Phase 7: Review<br/><i>CR + tests</i>"] -->|approve| P8
    P8["Phase 8: Documentation"] -->|GATE| P9
    P9["Phase 9: Deploy"]
